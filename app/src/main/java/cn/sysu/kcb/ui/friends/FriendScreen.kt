        ...
        Box(Modifier.weight(1f)) {
            if (courses.isEmpty() && weeks.isEmpty() && periods.isEmpty() && notes.isEmpty()) {
                ...
                TimetableGrid(
                    ...
                    periodHeightDp = settings.friendPeriodHeightDp,
                    todayHighlightEnabled = settings.friendTodayHighlightEnabled,
                    todayHighlightColor = settings.friendTodayHighlightColor,
                    todayHighlightAlpha = settings.friendTodayHighlightAlpha,
                    todayHighlightBarDp = settings.friendTodayHighlightBarDp,
                    periodHighlightEnabled = settings.friendPeriodHighlightEnabled,
                    periodHighlightColor = settings.friendPeriodHighlightColor,
                    periodHighlightAlpha = settings.friendPeriodHighlightAlpha,
                    periodHighlightBarDp = settings.friendPeriodHighlightBarDp,
